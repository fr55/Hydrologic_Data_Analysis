...
##You dont want the stats of the data. just the numbers
```
...
#bottom layer highly mixed. same temperature. In the surface there is also a mixed layer.
```
...
# we dont see mix. We get rapid temperature declineat this levels.
```
...
#ugly and also conects data that we dont have. Insert NAs in gaps to solve it.
```
...
#what is special 4°C. Maximum density. The coldest is it gonna get. 

#With ice all the column is 4°C. In may heats the surface. Light doesnt penetrate. part of the lake is still very cold. Epilineom (2-3 meters) surface mix layer.

#% hypelinium mix at the botom (from 5m and below)
...
<problems with the measurments. human mistakes>
...
<Something about not consistent profile because of mixing with the wind. Dimictic: mixes twice during the year (fall turnover) and spring (ice at the top at the begining)

For a lake to mix two things: wind and small enough density gradient>
