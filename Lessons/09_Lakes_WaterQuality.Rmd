...
LAGOStrophic <- 
  ...
  mutate(sampleyear = year(sampledate), 
         ...
         season = as.factor(quarter(sampledate, fiscal_start = 12))) #month 12.  Winter is going to be 1. including december. Kateri made the decision. You can break your seasonality the way it make sense to you.
%>%
  drop_na(chla:secchi)
