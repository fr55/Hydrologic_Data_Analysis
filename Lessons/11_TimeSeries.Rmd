...
#variance by season. Some ciclical things. Not very clear trend.
...
#linear regresion not very useful. The mean is a value that doenst make sense. You have many values below the mean. The seasonality is the problem. If you dont have seasonality linear could be efective. Anual means can be an oportutnity to use linear regresion.

#Try to choose the simpler model. But to simple sometimes dont work.
```
...
#for timeseries you only can provide one column. Something about you dont have the date. There is no information stored about date. Therefore, you need data that it is equidistant. For NAs you need an interpolation or eliminate every other day. 


table(diff(ClearCreekDischarge$Date))

# there is a gap. We wont bother for now.
